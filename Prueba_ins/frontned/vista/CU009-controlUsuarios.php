...
?>
    ...
    <script>
        function desactivarCuenta(id_to_delete) {
            ...
            if (confirmation) {
                window.location = "../global/api.php?apicall=desactivarUsuario&&id=" + id_to_delete;
            }
        }
    </script>
    <script>
        function activarCuenta(id_to_delete) {
            ...
            if (confirmation) {
                window.location = "../global/api.php?apicall=activarCuenta&&id=" + id_to_delete;
            }
        }
    </script>
...
?>
                    ...
                    <tbody>
                        ...
                        <td><img class="img-profile ml-3 rounded-circle mx-auto" src="../global/fonts/us/<?= $d['foto']; ?>" alt="Card image cap" height="65" width="70"></td>
                        <td><?= $d['FK_tipo_doc'] ?></td>
                        <td><?= $d['ID_us'] ?></td>
                        <td><?= $d['nom1'] ?></td>
                        <td><?= $d['nom2'] ?></td>
                        ...
                        <td>
                            <a href="http://localhost/proyecto/02)_Interface_grafica/mvc/vista/EditarUsuario.php?ID_us=<?= $d['ID_us'] ?> " class="btn btn-circle btn-dark"><i class="fas fa-marker"></i></a>
