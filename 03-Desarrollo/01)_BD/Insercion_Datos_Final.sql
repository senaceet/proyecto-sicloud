...
values		('1636012383599','Irma','Rosalyn','Mullen','Cote','1990-08-15','IKC07VII1NL','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariogirl.png','pulvinar.arcu.et@Nullatinciduntneque.org', 'CC'),
			('1695062224499','Charlotte',null,'Mccormick','Strong','1985-04-10','CIQ67PVL5EX','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariogirl.png','Sed.molestie@iaculisodio.org', 'CC'),
			('1662041247199','Elton','Hakeem','Morris','Howell','1988-09-19','JPC81QFH3JG','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariomenl.png','Donec.est@temporeratneque.net', 'CC'),
			('1660062872399','Ali','Reagan','Daniels','Owen','1992-02-11','FMU73YOW0MM','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariogirll.png','habitant.morbi.tristique@Nullamsuscipit.com', 'CC'),
			('1668040515399','Salvador','Desirae','Stevens',null,'1995-07-21','PWL76KXQ4FG','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariomenl.png','libero.lacus.varius@Quisque.co.uk', 'CC'),
			('1662101568299','Quin','Paki','Ford','Hahn','1992-07-28','GMU34EQF1NR','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariomenl.png','semper.tellus.id@Proinvelnisl.ca', 'CC'),
			('1694050100899','Jeremy',null,'Hahn','Trujillo','1990-04-11','SGU29VRZ0IS','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariogirll.png','nec@adipiscinglobortisrisus.net', 'CC'),
			('1628012272099','Dacey','Chanda','Gates','Foreman','1995-09-02','MWX02YMX4GM','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariogirll.png','cursus.vestibulum@Vivamusnon.edu', 'CC'),
			('1608051762299','Ayanna','Thor','Mayer',null,'1989-04-18','PPV93BGM9CX','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariogirll.png','eu.tellus@augue.com', 'CC'),
			('1670072699699','Keefe',null,'Fox','Shepard','1986-10-22','DQU71WDL2OY','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariomenl.png','Aliquam.gravida.mauris@egestas.net', 'CC'),
			('1676090228999','James','Oprah','Dickerson','Turner','1988-11-25','TUB17VSF8MZ','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariomenl.png','ut.molestie@morbitristiquesenectus.co.uk', 'CC'),
			('1623083099799','Aurelia',null,'Gordon','Merrill','1991-10-30','GZB91BTY9WN','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariogirl1.png','Integer.id@sedpede.ca', 'CC'),
			('1687060309399','Kylynn','Aubrey','Daniel',null,'1990-01-11','YDS91KRH4PL','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariomen1.png','mattis@eu.com', 'CC'),
			('1654011145999','Mollie','Jacqueline','Murphy','Henderson','1997-12-14','KDF36PDZ2DU','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariogirl1.png','nisi.magna@Nuncmauris.edu', 'CC'),
			('1692090422599','Dara',null,'Cook','Herrera','1984-05-17','PGW34XEV7KM','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariogirl1.png','scelerisque@nonante.edu', 'CC'),
			('1624060419399','Xenos','Libby','Flynn','Morris','1982-07-19','PVJ34CMM2DX','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariomen1.png','Curabitur@velitAliquamnisl.edu', 'CC'),
			('1651011048199','Rajah','Gage','Barry',null,'1987-12-19','BSZ77PRI6GH','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariomen1.png','lobortis.Class@egestasurna.ca', 'CC'),
			('1680091992499','Gloria',null,'Kirkland','Cote','1981-03-10','CFJ88XPJ2RM','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariogirl1.png','est.vitae@fermentum.edu', 'CC'),
			('1691012831199','Blake','Angela','Schroeder','Knight','1993-03-02','BMH07NRZ2UY','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariomen1.png','natoque.penatibus.et@quistristiqueac.ca', 'CC'),
			('1698091149999','Cedric',null,'Webster',null,'1991-06-10','WSF42WGJ0OS','E:\Andres\proyecto-sicloud-Dev\proyecto-sicloud-Dev\03-Desarrollo\01)_BD\Imagenes/usuariomen1.png','Curae.Phasellus@elitCurabitur.com', 'CC');
...
(default,'Chapinero',2),
(default,'Santa Fe',3),
(default,'San Cristóbal',4),
(default,'Kennedy',5),
(default,'Tunjuelito',6),
(default,'Bosa',7),
(default,'Fontibón',8),
(default,'Engativá',9),
(default,'Suba',10),
(default,'Barrios Unidos',11),
(default,'Teusaquillo',12),
(default,'Los Mártires',13),
(default,'Antonio Nariño',14),
(default,'Puente Aranda',15),
(default,'La Candelaria',16),
(default,'Rafael Uribe Uribe',17),
(default,'Ciudad Bolívar',18),
(default,'Usme',19),
(default,'Sumapaz',20);
