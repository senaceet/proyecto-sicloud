...
value		(default,2.77,'2018-12-04',8.46,7.69, 1),
			(default,9.80,'2018-12-23',5.69,4.11, 1),
			(default,3.25,'2019-08-16',4.90,4.27, 1),
			(default,8.38,'2019-08-17',4.73,5.32, 1),
			(default,4.71,'2019-07-19',5.43,1.27, 1),
			(default,6.01,'2019-02-02',2.52,5.37, 2),
			(default,3.70,'2019-09-28',0.94,2.54, 2),
			(default,3.03,'2019-02-16',9.72,3.50, 3),
			(default,6.40,'2018-12-30',4.48,9.14, 3),
			(default,9.14,'2019-10-18',8.74,7.69, 4),
			(default,9.00,'2018-12-20',6.42,7.46, 1),
			(default,5.08,'2019-05-13',4.27,6.09, 1),
			(default,0.12,'2019-10-19',5.38,9.34, 1),
			(default,7.00,'2019-10-12',4.42,9.11, 1),
			(default,1.67,'2019-01-08',7.18,0.45, 1),
			(default,5.78,'2019-09-23',4.56,3.74, 1),
			(default,8.59,'2019-06-23',7.23,6.63, 3),
			(default,1.84,'2019-02-03',2.61,9.85, 1),
			(default,6.97,'2019-01-19',5.95,2.44, 1),
			(default,3.60,'2019-07-05',0.74,8.23,1);
