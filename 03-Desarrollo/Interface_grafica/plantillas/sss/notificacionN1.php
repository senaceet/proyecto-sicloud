      ...
      <div class="modal-body">
        <table class="table table-striped bg-bordered bg-white table-sm col-md-10 col-sm-4 col-xs-12 mx-auto">
          <tbody>
            ...
            <tr>
              <td>
              <?php if(   $row['FK_not'] == 1 && $row['descript'] !=0    ){ $m = " Id usuario: ";}else{ $m ="" ;}  echo "Estoy en notificacion N1" ?>
                <a class="btn btn-success btn-circle" href=""><i class="fas fa-bell fa-fw"></i><a href="CU009-controlUsuarios.php=<?php echo $row['descript'] ?>&accion=bId"><?php echo "  " .$row['nom_tipo'].$m.$row['descript'] ?></a></a>
              </td>
            </tr>
        <?php  }
