            ...
            <div class="row">
                <table class="mx-auto">
                    ...
                    ?>
                         ...
                         <img class="card-body card-img-top  mx-auto" src="../imagenes/<?php echo $reg['6']; ?>" alt="Card image cap" height ="180px" width ="600px" >
                            <div class="  card-body my-2">
                                <h5 class="card-title"><?php echo $reg['1']; ?></h5>
                                <p class="card-text lead"><strong><?php echo "$".$reg['2']; ?></strong></p>
                                <p class="card-text text-success"><?php $c = $reg['2']; echo ($c/36)." Sin interes"; ?></p>
