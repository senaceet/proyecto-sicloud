...
class Categoria extends Conexion{
    ...
    public function insertCategoria()
    {
        ...
        $insert = $consultar->execute();
         if ($insert) { echo "<script>alert('Registro de categoria exitoso')</script>"; echo "<script>window.location.replace('../forms/formCategoria.php')</script>"; }
         else{ echo "<script>alert('Error de registro categoria')</script>"; echo "<script>window.location.replace('../forms/formCategoria.php')</script>";   } 
        if ($insert) {
    ...
    {       
        ...
        if ($rest3) { echo "<script>alert('Elimino el registro')</script>"; echo "<script>window.location.replace('../forms/formCategoria.php')</script>"; }
        else{ echo "<script>alert('Error al eliminar el registro categoria')</script>"; echo "<script>window.location.replace('../forms/formCategoria.php')</script>";   } 
          //  if ($rest3) {
