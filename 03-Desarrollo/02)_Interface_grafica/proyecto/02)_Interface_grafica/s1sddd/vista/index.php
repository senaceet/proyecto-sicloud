...
function selectDocumento(){
    //$objDoc = Documento::ningunDatoD();

    $objConDoc = new ControllerDoc();
    $datos = $objConDoc->selectDocumento();
    ...
    <div class="row">
        ...
        <div class="p-2 col-sm-12 col-md-4 col-lg-3 col-xl-4">
            <div class="card card-body text-center bg-dark  text-white   ">
                ...
                <form action="http://localhost/s1s/global/api.php?apicall=loginusuario" method="POST">
