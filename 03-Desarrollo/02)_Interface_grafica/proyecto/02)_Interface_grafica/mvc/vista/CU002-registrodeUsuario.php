...
<div class="container">
    <div class="row">
        <div class="col-md-10 card card-body mx-auto">
            <h5></h5>
            <form class="form-group" action="http://localhost/proyecto/02)_Interface_grafica/mvc/global/api.php?apicall=createusuario" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
