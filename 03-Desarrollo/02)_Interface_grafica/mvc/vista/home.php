<?php
include_once '../global/plantillas/nav/navgeneralvideo.php';
...
<article>
    <div class="container-jav">
        <video loop autoplay muted poster="../global/fonts/banner01.jpg" width="100%" class="bk-rgb-video">
            <source src="../global/fonts/boston.mp4" type="video/mp4">
        </video>
            ...
            <div id="carousel-1" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="../global/fonts/slider0.png" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="../global/fonts/slider1.png" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="../global/fonts/slider2.png" alt="Third slide">
                    </div>
                </div>
